...
PYTHON_INC_FLAGS=-I/opt/anaconda/include/python3.7m/ \
  -I/opt/anaconda/lib/python3.7/site-packages/numpy/core/include/numpy/

PYTHON_LD_FLAGS=`pkg-config --libs python-3.7`
